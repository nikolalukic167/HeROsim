...
def execute_reactive(base_dir, infra, peak_config, sim_input_path):
...
def worker_function(args):
    rep_idx, peak_config, base_dir, infra, sim_input_path, output_dir, start_time = args
    stats = execute_reactive(base_dir, infra, peak_config, sim_input_path)
    save_stats(output_dir, peak_config, stats, infra, f'reactive/{start_time}/{str(rep_idx)}')
...
def main():
    ...
    print(f'Loading infra {infra}, executing with {peak_config_file} using {num_cores} cores')
