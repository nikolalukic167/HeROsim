...
run_pipeline() {
    ...
    python -m src.optimizationinfra.generate "spaces/${space}" "${config_file}" 1 nofs-dnn1
    python -m src.optimizationinfra.sample "spaces/${space}" 5
    python -m src.optimizationinfra.initial "spaces/${space}" 5 nofs-dnn1
    python -m src.optimizationinfra.initialproactive "spaces/${space}" 5 nofs-dnn1
